      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Chatbot, Voicebot 등 고객의 모든 요청사항을 응답하는 Agent를 쉽게
            만들 수 있습니다
          </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  ...
                  학습하고 개선됩니다. 개인화된 경험을 제공하기 위한 스마트
                  메모리 시스템입니다.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    주문할 수 있습니다. 이전 주문 기록을 기반으로 개인화된
                    메뉴를 추천하고 프로모션을 자동으로 적용합니다.
                  </p>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    고객의 금융 거래 내역을 안전하게 기억하고 개인화된 재무
                    상담을 실시간으로 제공합니다.
                  </p>
                  <div className="text-xs text-muted-foreground border-t pt-2">
                    <strong>적용 기술:</strong> Agent + Memory + Rule
